 ...
 * arrive et y porte le focus au montage (`donnerLeFocus`) : le lecteur d'écran dit ce titre, puis
 ...
 * titre ordinaire : `StepShell` s'interdit le focus au premier rendu, parce que personne n'a encore
 * agi, et qu'un focus qui se déplace sans geste arrache le lecteur d'écran à ce qu'il lisait. Ici
 * l'écran n'existe qu'une fois le geste fait, donc son montage **est** la réponse au geste. Ne pas
 * l'employer sur un écran qui peut s'ouvrir sans geste — une route qu'on charge, un onglet qu'on
 * retrouve.
 *
 * Sur natif, l'enveloppe est un nœud d'accessibilité (`accessible`), avec le rôle d'en-tête du titre
 * qu'elle porte, pour que TalkBack ait à coup sûr un nœud à focaliser (`donnerLeFocus` dit
