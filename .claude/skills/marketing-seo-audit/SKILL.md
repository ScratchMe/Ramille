...
> If you see unfamiliar placeholders or need to check which tools are connected, see [CONNECTORS.md](../../plugins-importes/marketing/CONNECTORS.md).
...
User runs `/marketing-seo-audit` or asks for an SEO audit, keyword research, content gap analysis, technical SEO check, or competitor SEO comparison.
...
<!-- Modifié pour Ramille par scripts/installer-un-plugin.mjs : noms préfixés par « marketing- » (champ name, renvois aux commandes) et liens relatifs recalculés, appel manuel seulement (disable-model-invocation ; user-invocable rétabli s’il était à false). Plug-in marketing 1.2.0 ; licence et provenance dans .claude/plugins-importes/marketing/. -->
