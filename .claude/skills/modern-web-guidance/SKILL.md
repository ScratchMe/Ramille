...
<!-- Modifié pour Ramille par scripts/installer-un-plugin.mjs : noms préfixés par « modern-web-guidance- » (champ name, renvois aux commandes) et liens relatifs recalculés, appel manuel seulement (disable-model-invocation). Plug-in modern-web-guidance 0.0.190 ; licence et provenance dans .claude/plugins-importes/modern-web-guidance/. -->
