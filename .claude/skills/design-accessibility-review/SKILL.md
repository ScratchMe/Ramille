...
> If you see unfamiliar placeholders or need to check which tools are connected, see [CONNECTORS.md](../../plugins-importes/design/CONNECTORS.md).
...
```
/design-accessibility-review $ARGUMENTS
```
...
<!-- Modifié pour Ramille par scripts/installer-un-plugin.mjs : noms préfixés par « design- » (champ name, renvois aux commandes) et liens relatifs recalculés. Plug-in design 1.2.0 ; licence et provenance dans .claude/plugins-importes/design/. -->
