...
> If you see unfamiliar placeholders or need to check which tools are connected, see [CONNECTORS.md](../plugins-importes/product-management/CONNECTORS.md).
...
```
/product-management-brainstorm $ARGUMENTS
```
...
- "Want me to turn the top idea into a one-pager?" → `/one-pager` or `/product-management-write-spec`
- "Want me to map this into an opportunity solution tree?"
- "Want me to draft a research plan to test the riskiest assumption?" → `/product-management-synthesize-research`
- "Want me to check how competitors approach this?" → `/product-management-competitive-brief`
...
<!-- Modifié pour Ramille par scripts/installer-un-plugin.mjs : noms préfixés par « product-management- » (champ name, renvois aux commandes) et liens relatifs recalculés. Plug-in product-management 1.2.0 ; licence et provenance dans .claude/plugins-importes/product-management/. -->
