...
Neuf « Fait quand » de ce document ne se prouvent pas au clavier, et un dixième point est un
...
| 11.10 | C2.7 (l'écart par poste et le contour) | **Regarder les deux cartes neuves rendues**, dans les deux thèmes : l'écart par poste sur le suivi (six barres à **échelle commune** — une échelle par poste rendrait un poste de 40 kg aussi long qu'un poste de 2 t, et c'est le genre d'erreur qui ne se voit qu'à l'œil), et la barre-contour sur la restitution d'un re-bilan (1,5 px en `accentMuted` : à 1 px elle disparaît à l'antialiasing, à 2 px elle pèse autant qu'une barre pleine). Demande deux bilans à quelques mois d'écart sur le même compte, donc la même séance que 11.9 — et, tant qu'on y est, la vérification que la liste des points groupée par saison tient sur un téléphone étroit avec « Voir tout ». |
| 11.11 | C2.13 (la mascotte saisonnière) | **Regarder les quatre accessoires sur un vrai écran**, dans les deux thèmes, sur le plan, le suivi et l'onboarding — et il faut un **build natif**, la géométrie et les jetons touchant le composant. Ce qu'aucune suite ne peut dire, la géométrie ayant été vérifiée au rendu dans un navigateur mais pas sur un écran de téléphone : que le bonnet reste un bonnet à 28 px dans l'en-tête du questionnaire (à `k` maximal le pompon vaut la moitié de la calotte, ce qui est le principe de la compensation optique, mais se regarde) ; que le **cerne clair du pompon** se voie — il fait 0,71 px par construction, donc il se lit comme un halo, et s'il disparaît tout à fait c'est le rayon **extérieur** qu'on ouvre, jamais le cœur qu'on rétrécit ; que la calotte recouvrant le haut de la nervure ne laisse pas un moignon sous le revers ; et que les joues d'automne, découpées par la silhouette, ne se lisent pas comme une tache aplatie au bord. C'est aussi le moment de la décision laissée ouverte par le canvas : **printemps et été peuvent rester nus si quatre accessoires sont trop**. Même séance que 11.9 et 11.10. |
| 11.12 | C3.9 (la reprise) | **Interrompre un questionnaire, tuer l'app, la rouvrir** — et vérifier qu'on tombe sur l'écran de reprise et non sur les quatre écrans d'onboarding. C'est le « Fait quand » du point 3, et il ne se prouve qu'en tuant vraiment l'app : au navigateur, la racine est rechargée à chaque fois, donc le chemin est exercé sans l'être vraiment (l'état en mémoire n'a jamais survécu). Trois choses à regarder pendant qu'on y est : que le décompte dérivé dise la vérité pour un profil **sans trajet régulier** (le total n'est pas 9) ; que le bouton Google affiche bien le « G » officiel sur un appareil réel, où la densité d'écran diffère ; et que le mot de Ramille à l'entrée d'une section ne se lise pas comme une seconde mascotte à côté de celle de l'en-tête. |
| 11.13 | Onboarding (relevé en contre-lisant la vague 6) | **Regarder si l'étape 1 doit défiler.** Mesuré au rendu le 14/09/2026 : son contenu fait **890 px** à 360 de large (illustration 312, bloc de texte 308, pied 174, plus paddings et gouttières) et **896** à 390 — donc il ne tient dans aucun téléphone courant, y compris la taille de référence, où le lien « J'ai déjà un compte » était simplement **coupé en silence**. Les quatre pages absorbent maintenant (une page qui déborde défile, vérifié de 320×568 à 390×844 : toutes les cibles redeviennent atteignables), ce qui est strictement mieux qu'un bouton rogné — mais le premier écran du produit demande désormais un geste pour atteindre « Découvrir mon impact ». Réduire le contenu est une décision de design sur le canvas et non un correctif : l'illustration est le seul bloc compressible, et il faudrait la ramener à ~115 px pour tenir dans 640, ce qui n'est plus une illustration. À trancher sur appareil — garder le défilement, raccourcir le bloc de texte, ou accepter une illustration plus basse. |
