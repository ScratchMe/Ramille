...
| C4.5 | Hors-ligne : ouvrir sur le dernier plan connu ; session expirée — **requalifié le 14/09/2026** : c'est un démarrage impossible, pas un confort | P4 | grand | C1.4 | — |
...
|---|---|---|
| 12.2 — la taille du covoiturage sur l'écran suivant | chantier à part entière, petit | [#177](https://github.com/ScratchMe/TraceVerte/issues/177) |
...
Et un effet de bord à ne pas perdre de vue : **tant que ce chantier n'est pas livré, §11.5 ne peut pas
se faire.** Le parcours hors ligne écran par écran est derrière ce mur.
...
| C4.5 | [#147](https://github.com/ScratchMe/TraceVerte/issues/147) | | | **requalifié** par la recette du 14/09/2026 (§12.5, [#180](https://github.com/ScratchMe/TraceVerte/issues/180)) : un démarrage impossible, pas un confort. Bloque §11.5 |
...
d'ouverture se rend d'elle-même), **11.5** un chantier d'abord — elle est derrière le mur de §12.5 et
ne peut pas se faire avant lui. 11.4, qui n'a jamais été une vérification sur appareil mais un reste
...
| 12.2 | **La taille du covoiturage du trajet quotidien est sur l'écran suivant**, alors que les deux questions identiques ajoutées par C3.5 (sorties, longs trajets) s'ouvrent **sous l'option choisie**. Trois fois « vous êtes combien », deux motifs. Reste d'avant C3.5, qui a introduit le motif imbriqué sans reprendre l'ancienne ; la contre-lecture du 14/09 a aligné leurs **rôles d'accessibilité** sans voir que le **placement** divergeait. | À trancher — [#177](https://github.com/ScratchMe/TraceVerte/issues/177), vague 8 |
