...
| 11.W.9 | **Le contenu de l'e-mail de rattachement** (réécrit le 20/09/2026) — demandé par la personne qui pilote | **Le seul de ces contrôles qui se lise dans une boîte de réception, et pas à l'écran.** Fenêtre privée → `www.ramille.fr/connexion` → « Utiliser un email à la place » → l'écran « Continuer avec un email » → saisir l'adresse → « Recevoir le lien ». **L'adresse doit être une adresse qu'on contrôle et qui n'a AUCUN compte Ramille** : sur une adresse déjà rattachée, `updateUser` répond `email_exists`, l'écran affiche « Cette adresse a déjà un compte » et **aucun e-mail ne part** — la séance serait perdue à chercher un message qui n'a pas été envoyé. **Et il n'y a pas besoin de cliquer pour juger le contenu** : ne clique que si tu acceptes que l'adresse soit réellement rattachée, parce que ce clic crée un vrai compte en production. Cinq choses à regarder : l'objet est **« Cette adresse vient d'être saisie dans Ramille »** ; le corps ouvre par « L'adresse … vient d'être saisie dans Ramille » et **l'adresse y est bien écrite** (un blanc à cet endroit est le seul défaut que rien d'autre ne verrait — la substitution de variable a été éprouvée localement, jamais depuis la production) ; le bouton dit **« Confirmer, c'est bien moi »** et non « Confirmer » ; la sortie dit **« Si ce n'est pas toi, ne clique pas »** ; et le tout est en français, signé « — Ramille », pas par Supabase. **Puis la seule question qui demande un humain, et c'est pour elle que le texte a été réécrit** : relis-le en te mettant à la place de quelqu'un qui n'a rien demandé. Est-ce clair en deux secondes que ça ne parle pas d'un compte à toi, et qu'il n'y a rien à faire ? Si la réponse est non, le texte a raté son but, quand bien même chaque mot serait au bon endroit. |
