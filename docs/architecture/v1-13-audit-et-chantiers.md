...
| **8 — Lot 4** | C4.1, C4.2, C4.3, C4.4, C4.5, C4.7, C4.8 | chantier par chantier | Chacun précédé d'une page de décision. C4.6 a été avancé dans la vague 6. | 4 grands, 3 moyens |
