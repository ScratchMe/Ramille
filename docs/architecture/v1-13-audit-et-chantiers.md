...
| 11.W.3 | **L'encart de contexte et sa porte** (C5.5) | Bas du plan : une phrase qui énumère les réponses du contexte, **sans aucun chiffre et sans nommer d'action écartée**, et « Modifier ces réponses » qui ouvre le questionnaire **directement sur l'étape « Contexte »**, prérempli. Ce qui serait un défaut : arriver sur une autre étape, ou sur un questionnaire vide. |
