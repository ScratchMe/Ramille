...
ReactDOM.createRoot(document.getElementById('root')).render(
  <div style={{display:'grid',gridTemplateColumns:'minmax(0,1fr) minmax(0,1fr)',gap:20}}>
    <div style={{display:'flex',flexDirection:'column',gap:12}}>
      ...
      <CheckinCard periodLabel="Point de la semaine · 1 sept." question="…" answered="oui" pied="Répondu lundi. Prochain point : lundi 8 septembre." />
      <CheckinCard periodLabel="Point du mois · août" question="…" answered="non" emphasize={false} />
