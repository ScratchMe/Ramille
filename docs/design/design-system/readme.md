...
- Les échecs techniques se disent dans la page, ton neutre, ce qui est attendu plutôt que ce qui est faux : « Le mot de passe doit contenir au moins 8 caractères. »
...
- **Typographie** : Spline Sans seule (400/500/600/700). Échelle relevée : screen 26/32 (−0,26), salient 30/36 (−0,6), card 17/24, body 15/22, default 16/24, small 14/20, code mono 12. Titres 600, corps 500 (400 pour les longs paragraphes d'onboarding). Uniques : accroche 34/40, total 48/52, nom du lancement 30/38.
- **Espacement** : 2 / 4 / 8 / 16 / 24 / 32 / 64. Padding d'écran 24 ; gap de contenu 16–32 ; cartes padding 18–24.
- **Rayons** : puce 8, item de mode 14, champ 16, carte 18, pilule 22, bouton 27 (= hauteur 54 / 2). Cadre de présentation 40–44.
- **Hauteurs** : cible 44 minimum, bouton 54, champ 56, champ numérique 64, bande haute 52, barre d'onglets 60 + encoche.
...
- **Bande haute** : 52 px, nom centré 17/24/600, icône compte 22 dans une cible 44 à droite, bordure basse hairline. **Le nom, pas le visage.**
- **Barre d'onglets** : deux entrées, icônes trait 1,9 sur grille 24, pastille 56×30 `backgroundSelected` sur l'actif, libellé 12/16 (600 actif).
- **Transparence / flou** : jamais, sauf le scrim de feuille `rgba(19,22,18,0.42)` et l'action estompée (opacité 0,72) qui reste cliquable.
...
- **États** : pressé = pas de changement de couleur spécifié (Pressable natif) ; désactivé = fond élément + texte tertiaire, jamais une opacité ; focus = bordure accent 1,5 px sur les champs.
