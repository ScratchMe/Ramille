...
| 01.3 | **L'écran du mode, à l'étape « Comment fais-tu ce trajet ? »** — à observer pendant la traversée de 01.2, puis y **revenir** par le bouton Retour pour le remplir une seconde fois délibérément | **Ce n'est pas une conformité, c'est un jugement à rendre** (ouvert le 21/09/2026 avec C4.4, cf. `v1-13` §11.19). Depuis C4.4, **cinq des neuf entrées ouvrent une sous-question** sous l'élément choisi — « Voiture (seul) », « Voiture (covoiturage) » qui en ouvre deux, « Deux-roues motorisé », « Train », « Vélo » —, donc plus d'une sélection sur deux allonge l'écran. La question à laquelle la séance doit répondre, en une phrase : **est-ce que remplir cet écran est devenu pénible ?** Trois choses à regarder en le faisant : (a) l'encart imbriqué reste-t-il dans le champ de vision après la sélection, sans avoir à chercher — c'est sa raison d'être, il se rend **sous** l'élément choisi et non après la liste ; (b) comprend-on qu'il reste quelque chose à faire quand « Suivant » est grisé, ou cherche-t-on quoi ; (c) changer d'avis sur le mode une fois la sous-question remplie donne-t-il l'impression de recommencer. **Répondre même si tout est conforme** : une ligne muette se lira « pas joué ». Si la réponse est « oui, c'est pénible », la suite est un **brief de design** et non un correctif (`RECETTE.md` §2.4) | |
| 01.4 | **La question du télétravail** (dernière étape, C5.4) | « Sur tes 5 jours de trajet, combien pourrais-tu travailler depuis chez toi ? », et **trois** puces : Aucun / Un jour / Deux ou plus. Le mot « Parfois » ne doit apparaître nulle part | |
| 01.5 | Revenir en arrière et ramener le trajet à **1 jour** par semaine, puis revenir à l'étape Contexte | La question du télétravail **a disparu**, et « Voir mon bilan » ne reste pas bloqué en réclamant une réponse qu'on ne peut plus donner | |
| 01.6 | Remettre **5** jours, répondre « Un jour » au télétravail, soumettre | — | |
