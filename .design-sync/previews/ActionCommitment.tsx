 ...
 */
export const ChoixDesJours = () => <Cadre><ActionCommitment kind="days" state="picking" days={[1, 3]} /></Cadre>;

/** Pour les autres postes, une échéance fermée plutôt que des jours. */
export const ChoixDeLEcheance = () => (
  <Cadre><ActionCommitment kind="timing" state="picking" timing="mois_prochain" /></Cadre>
);
